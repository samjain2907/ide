  ...
  <div class="wrapper" @keydown="keyShortCuts">
    ...
    >
      ...
      <div class="download-modal-button-set flex-space-between">
        <button class="modal-button" @click="closeDownloadModal()">
          close
        </button>
        <button class="modal-button" @click="resetFileName()">
          reset file name
        </button>
        <button class="modal-button" @click="saveFileName()">
          save file name
        </button>
        <button class="modal-button" @click="downloadCode()">
          download code
        </button>
      </div>
    </modal>
    ...
    >
      <div class="shortcuts-modal-title flex-center">
        keyboard shortcuts
        <span @click="closeShortcutsModal()" class="shortcuts-modal-close"
          >×</span
        >
      </div>
      <ul class="shortcuts-modal-content">
        <li class="key-unit flex-space-between">
          ...
          <span class="key-description"
            >To run the program in windows/linux</span
          >
        </li>
        <li class="key-unit flex-space-between">
        ...
        <li class="key-unit flex-space-between">
          ...
          <span class="key-description"
            >To reset the settings in windows/linux</span
          >
        </li>
        <li class="key-unit flex-space-between">
        ...
        <li class="key-unit flex-space-between">
          ...
          <span class="key-description"
            >To reset the code in windows/linux</span
          >
        </li>
        <li class="key-unit flex-space-between">
        ...
        <li class="key-unit flex-space-between">
          ...
          <span class="key-description"
            >To download the code in windows/linux</span
          >
        </li>
        <li class="key-unit flex-space-between">
